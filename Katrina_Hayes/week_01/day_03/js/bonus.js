...
console.log("REVERSE STRING EXERCISE"); //for ease of viewing in console
...
const reverseString = function(string) {
  ...
  const newString = string.split('').reverse().join(''); //turn it into an array of strings, reverse array, join back as a string 
  return newString;
}
//test this out:
console.log(reverseString("wake"));
console.log(reverseString("forgotten"));

console.log("LONGEST WORD EXERCISE"); //for ease of viewing in console
...
console.log("SHORT WORD FILTER EXERCISE"); //for ease of viewing in console
