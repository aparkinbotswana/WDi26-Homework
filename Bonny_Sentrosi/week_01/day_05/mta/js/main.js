...
Lets work a solution for one line.

The hint is the stops need to be stored in an array and we need to jump along the array using indexOf()

We need to print out three logs:

"You must travel through the following stops on the N line.... blah blah blah."
"Change at Union square" - got a feeling to use an if for this. Such as if lineValueA !== lineValueB {log }
  because if the lineValues are the same there wouldnt be a change
"Your journey continues through the following stops"*/

/* test area
const mtaMap = [ 'Times Square', '34th', '28th', '23rd', 'Union Square',  '8th']

const startStation = "28th" maybe calls these startIndex to avoid using station so much

const endStation = "8th"

let startStation = "28th"
function myFunction() {
    var mtaMap = [ "Times Square", "34th", "28th", "23rd", "Union Square",  "8th"];
    var a = mtaMap.indexOf(startStation);
    document.getElementById("demo").innerHTML = a;
} */

// reversing the line... use a for loop but have the i equal the end of the array and increment down i--
