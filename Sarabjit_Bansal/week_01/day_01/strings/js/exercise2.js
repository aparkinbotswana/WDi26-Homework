...
//   DrEvil(1000000): 1000000 dollars (pinky)
  ...
  { let amtDollar = `${amount} dollars`;
  if (amount >= 1000000){
    amtDollar = `${amtDollar} (pinky)`;
  }
    console.log(amtDollar);
  };
...
const str1TwoChar = string1.substr(0,2);
const str2TwoChar = string2.substr(0,2);
...
const nwStr1 = str2TwoChar + remStr1 ;
const nwStr2 = str1TwoChar + remStr2 ;
